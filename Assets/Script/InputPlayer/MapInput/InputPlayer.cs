...
//     version 1.7.0
//     from Assets/Script/InputPlayer/MapInput/InputPlayer.inputactions
//
...
namespace Input
{
    ...
    ""controlSchemes"": []
            ...
            m_KeyMap_Executor = m_KeyMap.FindAction("Executor", throwIfNotFound: true);
        ...
        private readonly InputAction m_KeyMap_Executor;
        ...
        public struct KeyMapActions
        {
            ...
            public InputAction @Executor => m_Wrapper.m_KeyMap_Executor;
            ...
            public void AddCallbacks(IKeyMapActions instance)
            {
                ...
                @Executor.started += instance.OnExecutor;
                @Executor.performed += instance.OnExecutor;
                @Executor.canceled += instance.OnExecutor;
        ...
        public interface IKeyMapActions
        {
            ...
            void OnExecutor(InputAction.CallbackContext context);
